        ...
        if (!isEmptyObject) {
            ...
            if (!IsLevel2ObjectEmpty) {
                ...
                if (!IsLevel1ObjectEmpty) {
                    ...
                    objectArray = SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers;
                }
            }
...
function GetSetJsonMultilevelAllInspectionControls3(name, InspectionControlDataArray, codestandard, fieldsequence, id, isMetaInfo, selectedAnswerId1) {
...
function EditInspectionControlFields3(isObjectEmpty, oldControlId, currentSelectedVal, controlCaption, controlOption) {
    ...
    if (InspectionIndex > -1) {
        ...
        if (!isObjectEmpty) {
            multiLevelObject3.Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusIndex].InspectionInputTypeArray[InspectionFieldIndex].Caption = controlCaption;
            multiLevelObject3.Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusIndex].InspectionInputTypeArray[InspectionFieldIndex].Option = controlOption;
            isFieldPrivate = multiLevelObject3.Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusIndex].InspectionInputTypeArray[InspectionFieldIndex].IsFieldPrivate;
        }
        else {
            if (Level2QuestionIndex < 0 || Level2QuestionIndex == undefined) {
                multiLevelObject2.Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusIndex].InspectionInputTypeArray[InspectionFieldIndex].Caption = controlCaption;
                multiLevelObject2.Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusIndex].InspectionInputTypeArray[InspectionFieldIndex].Option = controlOption;
                isFieldPrivate = multiLevelObject2.Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusIndex].InspectionInputTypeArray[InspectionFieldIndex].IsFieldPrivate;
            }
            else {
                if (parentIndex < 0 || parentIndex == undefined) {
                    ...
                    multiLevelObject1.Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusndex].InspectionInputTypeArray[InspectionFieldIndex].Option = controlOption;
                    isFieldPrivate = multiLevelObject1.Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusndex].InspectionInputTypeArray[InspectionFieldIndex].IsFieldPrivate;
                }
                else {
                    if (sectionIndex < 0 || sectionIndex == undefined) {
                        ...
                        parentMultiLevelArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusIndex].InspectionInputTypeArray[InspectionFieldIndex].Option = controlOption;
                        isFieldPrivate = parentMultiLevelArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusIndex].InspectionInputTypeArray[InspectionFieldIndex].IsFieldPrivate;
                    }
                    else {
                        ...
                        SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusIndex].InspectionInputTypeArray[InspectionFieldIndex].Option = controlOption;
                        isFieldPrivate = SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusIndex].InspectionInputTypeArray[InspectionFieldIndex].IsFieldPrivate;
                    }
                }
            }
        }
...
function ClearMultilevelInspectionControls3() {
    debugger;
                    ...
                    if (parentIndex > -1) {
                        ...
                        if (sectionIndex > -1) {
                            ...
                            if (parentIndex > -1) {
                                ...
                                if (index > -1) {
                                    controlIndex = SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray.findIndex(m => m.Id == controlId);
                                    if (controlIndex > -1) {
                                        return {
                                            Level1AnswerIndex: Level1AnswerIndex,
                                            Level2QuestionIndex: Level2QuestionIndex,
        ...
        if (InspectionIndex > -1) {
            ...
            if (!isObjectEmpty) {
                ...
                if (index > -1) {
                    ...
                    if (controlIndex > -1) {
                        InspectionFieldIndex = multiLevelObject3.Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusIndex].InspectionInputTypeArray.findIndex(m => m.Id == controlId);
                ...
                if (!IsLevel2ObjectEmpty) {
                    ...
                    if (index > -1) {
                        ...
                        if (controlIndex > -1) {
                            InspectionFieldIndex = Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusIndex].InspectionInputTypeArray.findIndex(m => m.Id == controlId);
                            if (InspectionFieldIndex > -1) {
                                return {
                                    Level2AnswerIndex: Level2AnswerIndex,
                                    Level3QuestionIndex: Level3QuestionIndex,
                    ...
                    if (!IsLevel1ObjectEmpty) {
                        ...
                        if (parentIndex > -1) {
                            ...
                            if (index > -1) {
                                ...
                                if (controlIndex > -1) {
                                    InspectionFieldIndex = parentMultiLevelArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusIndex].InspectionInputTypeArray.findIndex(m => m.Id == controlId);
                                    if (InspectionFieldIndex > -1) {
                                        return {
                                            Level1AnswerIndex: Level1AnswerIndex,
                                            Level2QuestionIndex: Level2QuestionIndex,
                            ...
                            if (sectionIndex > -1) {
                                ...
                                if (parentIndex > -1) {
                                    ...
                                    if (index > -1) {
                                        ...
                                        if (controlIndex > -1) {
                                            InspectionFieldIndex = SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInspectionInputTypeArray[controlIndex].InspectionControlArray[currentSelectedStatusIndex].InspectionInputTypeArray.findIndex(m => m.Id == controlId);
                                            if (InspectionFieldIndex > -1) {
                                                return {
                                                    Level1AnswerIndex: Level1AnswerIndex,
                                                    Level2QuestionIndex: Level2QuestionIndex,
...
$(document).ready(function () {
    ...
    $("#SaveMultilevel3").click(function (e) {
        ...
        var Question = $("#txtMultilevelQuestion3").val();
        ...
        if (!isObjectEmpty) {
            ...
            multiLevelObject3.Question = Question;
                    ...
                    if (parentIndex > -1) {
                        ...
                        if (sectionIndex > -1) {
                            ...
                            if (parentIndex > -1) {
                                ...
                                if (Level1AnswerIndex > -1) {
                                    Level2QuestionIndex = $("#hdnLevel2QuestionIndex").val();
                                    Level2AnswerIndex = SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers.findIndex(m => m.Id == selectedAnswerId2);
                                    if (Level2AnswerIndex > -1) {
                                        SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray.push(multiLevelObject3);
                                    }
                                }
                            }
                        }
            ...
            if (!isLevel2ObjectEmpty) {
                ...
                multiLevelObject2.Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Question = Question;
                answersOptiontext = answersOption.join(',');
            }
            else {
                isLevel1ObjectEmpty = $.isEmptyObject(multiLevelObject1);
                if (!isLevel1ObjectEmpty) {
                    ...
                    multiLevelObject1.Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Question = Question;
                    answersOptiontext = answersOption.join(',');
                }
                else {
                    var parentId = $("#hdnParentMultilevelId1").val();
                    ...
                    if (parentIndex > -1) {
                        ...
                        parentMultiLevelArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Question = Question;
                        answersOptiontext = answersOption.join(',');
                    }
                    else {
                        var sectionId = $("#OldSectionId").val();
                        ...
                        if (sectionIndex > -1) {
                            ...
                            if (parentIndex > -1) {
                                ...
                                Level2AnswerIndex = $("#hdnLevel2AnswerIndex").val();
                                Level3QuestionIndex = $("#hdnLevel3QuestionIndex").val();
                                $.each(SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers, function (index) {
                                    answersOption.push(SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].FieldCaption);
                                });
                                Id = SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Id;
                                SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Question = Question;
                                answersOptiontext = answersOption.join(',');
                            }
                        }
                    }
    ...
    $("#AddMultilevelControlOptions3").click(function () {
        ...
        if (IsFieldforEdit == "true") {
            ...
            if (InspectionControlName == "InspectionControl") {
               ...
               IsFieldPrivate =  EditInspectionControlFields3(isObjectEmpty, oldControlId, currentSelectedVal, controlCaption, controlOption);
            }
            else {
                ...
                if (!isObjectEmpty) {
                    multiLevelObject3.Answers[index].MultiLevelInputTypeArray[controlIndex].Type = controlType;
                    multiLevelObject3.Answers[index].MultiLevelInputTypeArray[controlIndex].Caption = controlCaption;
                    multiLevelObject3.Answers[index].MultiLevelInputTypeArray[controlIndex].Option = controlOption;
                    IsFieldPrivate = multiLevelObject3.Answers[index].MultiLevelInputTypeArray[controlIndex].IsFieldPrivate;
                }
                else {
                    if (Level2QuestionIndex < 0 || Level2QuestionIndex == undefined) {
                        multiLevelObject2.Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Type = controlType;
                        multiLevelObject2.Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Caption = controlCaption;
                        multiLevelObject2.Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Option = controlOption;
                        IsFieldPrivate = multiLevelObject2.Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].IsFieldPrivate;
                    }
                    else {
                        if (parentIndex < 0 || parentIndex == undefined) {
                            multiLevelObject1.Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Type = controlType;
                            multiLevelObject1.Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Caption = controlCaption;
                            multiLevelObject1.Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Option = controlOption;
                            IsFieldPrivate = multiLevelObject1.Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].IsFieldPrivate;
                        }
                        else {
                            if (sectionIndex < 0 || sectionIndex == undefined) {
                                parentMultiLevelArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Type = controlType;
                                parentMultiLevelArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Caption = controlCaption;
                                parentMultiLevelArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Option = controlOption;
                                IsFieldPrivate = parentMultiLevelArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].IsFieldPrivate;
                            }
                            else {
                                SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Type = controlType;
                                SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Caption = controlCaption;
                                SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Option = controlOption;
                                IsFieldPrivate = SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].IsFieldPrivate;
                            }
                        }
                    }
                }
    ...
    $(".multilevel_fields_container_3").on("click", ".multilevel_edit_field,.multilevel_remove_field,.multilevel_private_field", function () {
        ...
        if (!isObjectEmpty) { //Edit in the create mode
            if (className == "multilevel_edit_field") {
                controlType = multiLevelObject3.Answers[index].MultiLevelInputTypeArray[controlIndex].Type;
                controlCaption = multiLevelObject3.Answers[index].MultiLevelInputTypeArray[controlIndex].Caption;
                controlOption = multiLevelObject3.Answers[index].MultiLevelInputTypeArray[controlIndex].Option;
            }
            ...
            if (Level2QuestionIndex < 0 || Level2QuestionIndex == undefined) {//Edit from Level2
                if (className == "multilevel_edit_field") {
                    controlType = multiLevelObject2.Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Type;
                    controlCaption = multiLevelObject2.Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Caption;
                    controlOption = multiLevelObject2.Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Option;
                }
                else if (className == "multilevel_remove_field") {
                ...
                if (parentIndex < 0 || parentIndex == undefined) { //Edit from Level1
                    if (className == "multilevel_edit_field") {
                        controlType = multiLevelObject1.Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Type;
                        controlCaption = multiLevelObject1.Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Caption;
                        controlOption = multiLevelObject1.Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Option;
                    }
                    else if (className == "multilevel_remove_field") {
                    ...
                    if (sectionIndex < 0 || sectionIndex == undefined) { //Edit from Section
                        if (className == "multilevel_edit_field") {
                            controlType = parentMultiLevelArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Type;
                            controlCaption = parentMultiLevelArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Caption;
                            controlOption = parentMultiLevelArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Option;
                        }
                        else if (className == "multilevel_remove_field") {
                        ...
                        if (className == "multilevel_edit_field") { // Edit from Main Form Page
                            controlType = SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Type;
                            controlCaption = SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Caption;
                            controlOption = SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Option;
                        }
                        else if (className == "multilevel_remove_field") {
                            SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray.splice(controlIndex, 1);
                        }
                        else if (className == "multilevel_private_field") {
                            SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].IsFieldPrivate = ischecked;
                        }
                    }
                }
            }
        ...
        if (className == "multilevel_edit_field") {
            if (controlType == 'TextBox') {
                if (TextBoxCaptionInput()) {
                    if (!isObjectEmpty) {
                        multiLevelObject3.Answers[index].MultiLevelInputTypeArray[controlIndex].Caption = TextboxCaption;
                    }
                    else if (Level2QuestionIndex < 0 || Level2QuestionIndex == undefined) {
                        multiLevelObject2.Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Caption = TextboxCaption;
                    }
                    else if (parentIndex < 0 || parentIndex == undefined) {
                        multiLevelObject1.Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Caption = TextboxCaption;
                    }
                    else if (sectionIndex < 0 || sectionIndex == undefined) {
                        parentMultiLevelArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Caption = TextboxCaption;
                    }
                    else {
                        SectionDataArray[sectionIndex].MultiLevelTypeArray[parentIndex].Answers[Level1AnswerIndex].MultiLevelArray[Level2QuestionIndex].Answers[Level2AnswerIndex].MultiLevelArray[Level3QuestionIndex].Answers[index].MultiLevelInputTypeArray[controlIndex].Caption = TextboxCaption;
                    }
